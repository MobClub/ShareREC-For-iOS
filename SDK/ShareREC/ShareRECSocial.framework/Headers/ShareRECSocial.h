...
typedef NS_ENUM(NSInteger, SREShareResponseState) {
    //开始
    SREShareResponseStateBegin = 0,
    //成功
    SREShareResponseStateSuccess = 1,
    //失败
    SREShareResponseStateFail = 2,
    //取消
    SREShareResponseStateCancel = 3
};
...
+ (void)openByTitle:(NSString *)title
           ...
           pageType:(ShareRECSocialPageType)pageType
            onClose:(void(^)())closeHandler
        shareResult:(void (^)(SREShareResponseState shareState))shareResult;
